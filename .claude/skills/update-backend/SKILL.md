...
The fastest path is the scaffolder: `shbench new <name>` (or `make new
...
4. Smoke-test headlessly with `shbench`:
...
- [ ] `cargo test` passes
- [ ] New command smoke-tested with `shbench call <cmd> --json`
