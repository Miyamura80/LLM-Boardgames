//! Catan match orchestration: init → continue → cleanup over a schedule,
...
use super::schedule::{arena_schedule, controlled_schedule, GamePlan};
use crate::catan::metrics::score_game;
use crate::catan::rating::{leaderboard, LeaderboardRow, RatingTable};
use crate::catan::store::CatanStore;
...
pub enum MatchSpec {
    /// One candidate vs a frozen 3-anchor pool: boards × 4 seats × K reps.
    Controlled {
        candidate: AgentSpec,
        pool_name: String,
        pool: Vec<AgentSpec>,
