...
fn golden_prompt_render() -> String {
    ...
    // Every event render arm, via a driven sample game's transcript.
    for record in &crate::catan::agents::prompts::sample_events() {
...
pub(crate) fn sample_events() -> Vec<crate::catan::events::CatanEvent> {
